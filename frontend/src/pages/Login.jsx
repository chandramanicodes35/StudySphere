...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email.trim() || !password.trim()) {
      return setValidationError('Please fill in all credential fields.');
    }
    ...
    <div className="min-h-screen bg-dark-900 text-slate-100 flex flex-col justify-center items-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl relative flex flex-col gap-6 shadow-2xl">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white mt-1">Welcome Back</h2>
          <p className="text-xs text-slate-400 text-center">Log in to enter your study rooms and catch streaks.</p>
        </div>
